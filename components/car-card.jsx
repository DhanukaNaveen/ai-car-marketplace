      ...
      <CardContent className="p-4">
        ...
        <div className="flex justify-between">
          <Button
            ...
            }} // When the user clicks the "View Car" button, we use the router.push method to navigate them to the car's detail page, which is located at /cars/[id]. The [id] part of the URL is a dynamic segment that corresponds to the specific car's ID, allowing us to display the details for that particular car on the next page.
          >
            View Car
          </Button>
        </div>
